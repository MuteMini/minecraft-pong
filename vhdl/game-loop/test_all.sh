...
# Wall Collider Test
ghdl --remove --workdir=work
ghdl -a --workdir=work --std=08 ./common/*.vhdl ./game-loop/wall_collider*.vhdl
ghdl --elab-run --workdir=work --std=08 wall_collider_tb

# Ball Updater Test
ghdl --remove --workdir=work
ghdl -a --workdir=work --std=08 ./common/*.vhdl ./game-loop/paddle_collider*.vhdl ./game-loop/wall_collider*.vhdl \
    ./game-loop/ball_updater*.vhdl 
